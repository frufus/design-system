...
export const PAIRS = [
  ...
  ['ink-subtle', 'surface', 3, 'a count or key above a heading - secondary, never a control'],
  ['ink-muted', 'surface-sunken', 4.5, 'placeholder text, and text in a sunken strip'],
  ['ink', 'disabled-surface', 4.5, 'neutral badge text'],
  ['accent-ink', 'surface-sunken', 4.5, 'the chosen option while it is active'],
